...
sky_all='/Users/amartinez/Desktop/PhD/KMOS/data/sky_all/end_products/2022-01-19T18_50_14/KMOS.2021-06-03T04_47_47.641_combine_OBs/'


# s_file = g t_pkg_data_filename(sky_all+'GC_K_Sky_SCI_RECONSTRUCTED_KMOS.2021-06-03T04:50:11.622.fits')
...
s_file=get_pkg_data_filename('GC_K_Sky_SCI_RECONSTRUCTED_KMOS.2021-06-03T04:50:11.622.fits')


 
s_header=fits.getheader(sky_all+'GC_K_Sky_SCI_RECONSTRUCTED_KMOS.2021-06-03T04:50:11.622.fits')
        ...
        for j in ifu_valid:
            for x in range(14):
                for y in range(14):
                    ...
                    elif (hdu[j].data[cube_depth,x,y] > sky_median_all[cube_depth] + 3*sky_std_all[cube_depth]):
                       hdu[j].data[cube_depth,x,y ]= sky_std_all[cube_depth]*np.random.random() + sky_median_all[cube_depth]
#%%
...
new_hdul.writeto(pruebas+'sky_test.fits',overwrite=True)
